 ...
 * @file     system_M5531.c
 * @version  V1.00
 * @brief    CMSIS Device System Source File for NuMicro M5531
 *
...
__WEAK int32_t InitPreDefMPURegion(const ARM_MPU_Region_t *psMPURegion, uint32_t u32RegionCnt)
{
    ...
    if (psMPURegion != NULL)
    {
        //printf("u32RegionCnt: %d, (MPU_REGIONS_MAX - u32RegionIdx): %d\n", u32RegionCnt, (MPU_REGIONS_MAX - u32RegionIdx));

        if (u32RegionCnt < (MPU_REGIONS_MAX - u32RegionIdx - 1))
