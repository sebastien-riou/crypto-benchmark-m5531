 ...
 * @file     M5531.h
 * @version  V2.00
 * @brief    Peripheral Access Layer Header File for NuMicro M5531
 *
...
/**
  \mainpage NuMicro M5531 Series CMSIS BSP Driver Reference
  *
  * <b>Introduction</b>
  *
  * This user manual describes the usage of M5531 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
#include "system_M5531.h"                     /* System header */
#if __has_include("partition_M5531.h")
#include "partition_M5531.h"                  /* User defined setup for Secure/Non-Secure Zones */
#else
#include "partition_M5531_template.h"         /* Default setup for Secure/Non-Secure Zones */
#endif

#if __has_include("mpu_config_M5531.h")
#include "mpu_config_M5531.h"                  /* User defined setup for MPU regions */
#else
#include "mpu_config_M5531_template.h"         /* Default setup for MPU regions */
#endif
