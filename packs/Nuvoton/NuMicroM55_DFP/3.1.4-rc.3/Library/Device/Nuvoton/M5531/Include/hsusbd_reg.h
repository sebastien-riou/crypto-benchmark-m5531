...
#define HSUSBD_BUSINTSTS_LPMTKNIF_Pos    (9)                                               /*!< HSUSBD_T::BUSINTSTS: LPMTKNIF Position */
#define HSUSBD_BUSINTSTS_LPMTKNIF_Msk    (0x1ul << HSUSBD_BUSINTSTS_LPMTKNIF_Pos)          /*!< HSUSBD_T::BUSINTSTS: LPMTKNIF Mask     */
...
#define HSUSBD_BUSINTEN_LPMTKNIEN_Pos    (9)                                               /*!< HSUSBD_T::BUSINTEN: LPMTKNIEN Position */
#define HSUSBD_BUSINTEN_LPMTKNIEN_Msk    (0x1ul << HSUSBD_BUSINTEN_LPMTKNIEN_Pos)          /*!< HSUSBD_T::BUSINTEN: LPMTKNIEN Mask     */
...
#define HSUSBD_BCDC_BCDEN_Pos            (0)                                               /*!< HSUSBD_T::BCDC: BCDEN Position         */
#define HSUSBD_BCDC_BCDEN_Msk            (0x1ul << HSUSBD_BCDC_BCDEN_Pos)                  /*!< HSUSBD_T::BCDC: BCDEN Mask             */

#define HSUSBD_BCDC_DETMOD_Pos           (1)                                               /*!< HSUSBD_T::BCDC: DETMOD Position        */
#define HSUSBD_BCDC_DETMOD_Msk           (0x7ul << HSUSBD_BCDC_DETMOD_Pos)                 /*!< HSUSBD_T::BCDC: DETMOD Mask            */

#define HSUSBD_BCDC_DETSTS_Pos           (4)                                               /*!< HSUSBD_T::BCDC: DETSTS Position        */
#define HSUSBD_BCDC_DETSTS_Msk           (0x1ul << HSUSBD_BCDC_DETSTS_Pos)                 /*!< HSUSBD_T::BCDC: DETSTS Mask            */

#define HSUSBD_BCDC_USP_Pos              (5)                                               /*!< HSUSBD_T::BCDC: USP Position           */
#define HSUSBD_BCDC_USP_Msk              (0x1ul << HSUSBD_BCDC_USP_Pos)                    /*!< HSUSBD_T::BCDC: USP Mask               */

#define HSUSBD_BCDC_BCDIEN_Pos           (30)                                              /*!< HSUSBD_T::BCDC: BCDIEN Position        */
#define HSUSBD_BCDC_BCDIEN_Msk           (0x1ul << HSUSBD_BCDC_BCDIEN_Pos)                 /*!< HSUSBD_T::BCDC: BCDIEN Mask            */
...
#define HSUSBD_LPMCSR_LPMSLEEPEN_Pos     (13)                                              /*!< HSUSBD_T::LPMCSR: LPMSLEEPEN Position  */
#define HSUSBD_LPMCSR_LPMSLEEPEN_Msk     (0x1ul << HSUSBD_LPMCSR_LPMSLEEPEN_Pos)           /*!< HSUSBD_T::LPMCSR: LPMSLEEPEN Mask      */

#define HSUSBD_LPMCSR_LPMSENDNYET_Pos    (14)                                              /*!< HSUSBD_T::LPMCSR: LPMSENDNYET Position */
#define HSUSBD_LPMCSR_LPMSENDNYET_Msk    (0x1ul << HSUSBD_LPMCSR_LPMSENDNYET_Pos)          /*!< HSUSBD_T::LPMCSR: LPMSENDNYET Mask     */
...
#define HSUSBD_PHYCTL_VBUSWKEN_Pos       (24)                                              /*!< HSUSBD_T::PHYCTL: VBUSWKEN Position    */
#define HSUSBD_PHYCTL_VBUSWKEN_Msk       (0x1ul << HSUSBD_PHYCTL_VBUSWKEN_Pos)             /*!< HSUSBD_T::PHYCTL: VBUSWKEN Mask        */

#define HSUSBD_PHYCTL_LINESTATEWKEN_Pos  (25)                                              /*!< HSUSBD_T::PHYCTL: LINESTATEWKEN Position*/
#define HSUSBD_PHYCTL_LINESTATEWKEN_Msk  (0x1ul << HSUSBD_PHYCTL_LINESTATEWKEN_Pos)        /*!< HSUSBD_T::PHYCTL: LINESTATEWKEN Mask   */

#define HSUSBD_PHYCTL_STALLREVERT_Pos    (26)                                              /*!< HSUSBD_T::PHYCTL: STALLREVERT Position */
#define HSUSBD_PHYCTL_STALLREVERT_Msk    (0x1ul << HSUSBD_PHYCTL_STALLREVERT_Pos)          /*!< HSUSBD_T::PHYCTL: STALLREVERT Mask     */

#define HSUSBD_PHYCTL_PHYCLKSTB_Pos      (27)                                              /*!< HSUSBD_T::PHYCTL: PHYCLKSTB Position   */
#define HSUSBD_PHYCTL_PHYCLKSTB_Msk      (0x1ul << HSUSBD_PHYCTL_PHYCLKSTB_Pos)            /*!< HSUSBD_T::PHYCTL: PHYCLKSTB Mask       */
