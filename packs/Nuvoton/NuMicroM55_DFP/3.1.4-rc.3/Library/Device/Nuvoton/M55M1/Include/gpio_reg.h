...
typedef struct
{
    /**
     * @var GPIO_T::MODE
     * Offset: 0x00/0x40/0x80/0xC0/0x100/0x140/0x180/0x1C0/0x200/0x240  Port A-J I/O Mode Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[2n+1:2n]|MODEn    |Port A-J I/O Pin[n] Mode Control
     ...
     * @var GPIO_T::DINOFF
     * Offset: 0x04/0x44/0x84/0xC4/0x104/0x144/0x184/0x1C4/0x204/0x244  Port A-J Digital Input Path Disable Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n+16]  |DINOFFn   |Port A-J Pin[n] Digital Input Path Disable Control
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::DOUT
     * Offset: 0x08/0x48/0x88/0xC8/0x108/0x148/0x188/0x1C8/0x208/0x248  Port A-J Data Output Value
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |DOUTn     |Port A-J Pin[n] Output Value
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::DATMSK
     * Offset: 0x0C/0x4C/0x8C/0xCC/0x10C/0x14C/0x18C/0x1CC/0x20C/0x24C  Port A-J Data Output Write Mask
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |DATMSKn   |Port A-J Pin[n] Data Output Write Mask
     ...
     * |        |          |Note 1: This function only protects the corresponding DOUT (Px_DOUT[n]) bit, and will not protect the corresponding PDIO (Pxn_PDIO[n]) bit.
     * |        |          |Note 2:
     * |        |          |Max. n=15 for port A/B/E/G/I.
     * |        |          |Max. n=14 for port C/D.
     * |        |          |Max. n=13 for port J.
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::PIN
     * Offset: 0x10/0x50/0x90/0xD0/0x110/0x150/0x190/0x1D0/0x210/0x250  Port A-J Pin Value
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |PINn      |Port A-J Pin[n] Pin Value
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::DBEN
     * Offset: 0x14/0x54/0x94/0xD4/0x114/0x154/0x194/0x1D4/0x214/0x254  Port A-J De-Bounce Enable Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |DBENn     |Port A-J Pin[n] Input Signal De-Bounce Enable Bit
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::INTTYPE
     * Offset: 0x18/0x58/0x98/0xD8/0x118/0x158/0x198/0x1D8/0x208/0x258  Port A-J Interrupt Trigger Type Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |TYPEn     |Port A-J Pin[n] Edge or Level Detection Interrupt Trigger Type Control
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |FLIENn    |Port A-J Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Bit
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::INTSRC
     * Offset: 0x20/0x60/0xA0/0xE0/0x120/0x160/0x1A0/0x1E0/0x220/0x260  Port A-J Interrupt Source Flag
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |INTSRCn   |Port A-J Pin[n] Interrupt Source Flag
     * |        |          |Write Operation :
     * |        |          |0 = No action.
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::SMTEN
     * Offset: 0x24/0x64/0xA4/0xE4/0x124/0x164/0x1A4/0x1E4/0x224/0x264  Port A-J Input Schmitt Trigger Enable Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |SMTENn    |Port A-J Pin[n] Input Schmitt Trigger Enable Bit
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::SLEWCTL
     * Offset: 0x28/0x68/0xA8/0xE8/0x128/0x168/0x1A8/0x1E8/0x228/0x268  Port A-J High Slew Rate Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::PUSEL
     * Offset: 0x30/0x70/0xB0/0xF0/0x130/0x170/0x1B0/0x1F0/0x230/0x270  Port A-J Pull-up and Pull-down Selection Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[2n+1:2n]|PUSELn   |Port A-J Pin[n] Pull-up and Pull-down Enable Register
     ...
     * |        |          |Max. n=11 for port F/H.
     * @var GPIO_T::DBCTL
     * Offset: 0x34/0x74/0xB4/0xF4/0x134/0x174/0x1B4/0x1F4/0x234/0x274  Port A-J Interrupt De-bounce Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
...
typedef struct
{
    ...
    __IO uint32_t INT0_INNF;     /* Offset: 0x440  INT0 Input Noise Filter Register                                             */
    ...
    __IO uint32_t INT7_EDSTS;    /* Offset: 0x52c  INT7 Edge Detect Interrupt Flag Register                                     */
...
#define GPIO_DBCTL_DBCLKBUSY_Msk         (1ul << GPIO_DBCTL_DBCLKBUSY_Pos)                 /*!< GPIO_T::DBCTL: DBCLKBUSY Mask          */
...
#define GPIO_INT_EDETCTL_EDETCTL_Pos     (0)                                               /*!< GPIO_T::INT_EDETCTL: EDETCTL Position  */
#define GPIO_INT_EDETCTL_EDETCTL_Msk     (0x3ul << GPIO_INT_EDETCTL_EDETCTL_Pos)           /*!< GPIO_T::INT_EDETCTL: EDETCTL Mask      */

#define GPIO_INT_EDINTEN_EDIEN_Pos       (0)                                               /*!< GPIO_T::INT_EDINTEN: EDIEN Position    */
#define GPIO_INT_EDINTEN_EDIEN_Msk       (0x1ul << GPIO_INT_EDINTEN_EDIEN_Pos)             /*!< GPIO_T::INT_EDINTEN: EDIEN Mask        */

#define GPIO_INT_EDSTS_EDIF_Pos          (0)                                               /*!< GPIO_T::INT_EDSTS: EDIF Position       */
#define GPIO_INT_EDSTS_EDIF_Msk          (0x1ul << GPIO_INT_EDSTS_EDIF_Pos)                /*!< GPIO_T::INT_EDSTS: EDIF Mask           */
