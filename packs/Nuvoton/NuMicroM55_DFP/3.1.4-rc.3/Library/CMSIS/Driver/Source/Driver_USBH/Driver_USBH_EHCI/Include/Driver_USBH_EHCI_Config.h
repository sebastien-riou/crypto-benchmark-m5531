...
#ifndef DRIVER_USBH_EHCI_CONFIG_H_
#define DRIVER_USBH_EHCI_CONFIG_H_
...
#define USBH0_EHCI_BASE_ADDR            0x40204000
...
#define USBH0_EHCI_COM_AREA_LOCATE      1

//     <s.64>Section name
//       <i>Specifies the section name for the EHCI communication area
//       <i>(for positioning via the linker script)
#define USBH0_EHCI_COM_AREA_SECTION_NAME ".bss.NonCacheable.ZeroInit"
//   </e>
// </h>
...
#endif /* DRIVER_USBH_EHCI_CONFIG_H_ */
