...
#ifndef DRIVER_USBH_OHCI_CONFIG_H_
#define DRIVER_USBH_OHCI_CONFIG_H_
...
#define USBH0_OHCI_BASE_ADDR            0x40203000

//   <e>Locate OHCI Communication Area (HCCA)
//     <i>Specifies if the communication area is located in a specific memory
//     <i>(via the linker script)
#define USBH0_OHCI_HCCA_LOCATE          1

//     <s.64>Section name
//       <i>Specifies the section name for the OHCI communication area
//       <i>(for positioning via the linker script)
#define USBH0_OHCI_HCCA_SECTION_NAME    ".bss.NonCacheable.ZeroInit"
//   </e>
// </h>

// <e>USB Host Controller 1
//   <i>Enables or disables USB Host Controller 1 Driver
#define USBH1_OHCI_ENABLED              1

//   <o>Export control block Driver_USBH# <0-255>
//     <i>Specifies the exported driver control block number
//     <i>For example, for value 1 the exported driver control block will be Driver_USBH1
#define USBH1_OHCI_DRV_NUM              2

//   <o>OHCI Registers base address <0-0xFFFFFFFF>
//     <i>Specifies the absolute address at which OHCI controller registers are located
#define USBH1_OHCI_BASE_ADDR            0x40202000

//   <e>Locate OHCI Communication Area (HCCA)
//     <i>Specifies if the communication area is located in a specific memory
//     <i>(via the linker script)
#define USBH1_OHCI_HCCA_LOCATE          1

//     <s.64>Section name
//       <i>Specifies the section name for the OHCI communication area
//       <i>(for positioning via the linker script)
#define USBH1_OHCI_HCCA_SECTION_NAME    ".bss.NonCacheable.ZeroInit"
//   </e>
// </e>
...
#endif /* DRIVER_USBH_OHCI_CONFIG_H_ */
