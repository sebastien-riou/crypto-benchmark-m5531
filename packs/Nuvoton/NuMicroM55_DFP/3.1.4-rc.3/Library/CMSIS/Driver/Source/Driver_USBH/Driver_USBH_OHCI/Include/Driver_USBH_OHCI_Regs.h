...
#ifndef DRIVER_USBH_OHCI_REGS_H_
#define DRIVER_USBH_OHCI_REGS_H_
...
#define USBH_OHCI_HcInterruptEnable_RHSC (1UL <<  6)
#define USBH_OHCI_HcInterruptEnable_FNO  (1UL <<  5)
#define USBH_OHCI_HcInterruptEnable_RD   (1UL <<  3)
#define USBH_OHCI_HcInterruptEnable_SF   (1UL <<  2)
#define USBH_OHCI_HcInterruptEnable_WDH  (1UL <<  1)
#define USBH_OHCI_HcInterruptEnable_SO   (1UL      )

// HcInterruptStatus Register bits
#define USBH_OHCI_HcInterruptStatus_ALL  (0x0000006FU)
