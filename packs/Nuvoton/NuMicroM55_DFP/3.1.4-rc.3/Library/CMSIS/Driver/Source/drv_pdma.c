...
static int nu_pdma_non_transfer_count_get(int32_t i32ChannID)
{
    ...
    if (0 == (PDMA->DSCT[NU_PDMA_GET_MOD_CHIDX(i32ChannID)].CTL & PDMA_DSCT_CTL_TXCNT_Msk))
    {
        return (PDMA->DSCT[NU_PDMA_GET_MOD_CHIDX(i32ChannID)].CTL & PDMA_DSCT_CTL_OPMODE_Msk ? 1 : 0);
    }
