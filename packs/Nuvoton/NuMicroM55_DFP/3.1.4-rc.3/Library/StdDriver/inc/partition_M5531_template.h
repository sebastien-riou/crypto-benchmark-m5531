/**************************************************************************//**
 * @file     partition_M5531_template.h
 * @version  V1.00
 * @brief    Default Initial Setup for Secure / Non-secure Attribution Zones for M5531
 *
 * SPDX-License-Identifier: Apache-2.0
 * @copyright (C) 2023 Nuvoton Technology Corp. All rights reserved.
 ******************************************************************************/

#ifndef PARTITION_M5531_TEMPLATE_H
#define PARTITION_M5531_TEMPLATE_H
...
/*
   <e>Initialize SAU Region 4 (Config Non-secure Callable in system_M5531.c)
...
#endif  /* PARTITION_M5531_TEMPLATE_H */
